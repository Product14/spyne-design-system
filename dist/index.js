...
const Button = react.forwardRef(({ variant = 'primary', size = 'md', fullWidth = false, loading = false, leftIcon, rightIcon, children, className = '', disabled, ...props }, ref) => {
    ...
    const classes = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("button", { ref: ref, className: classes, disabled: disabled || loading, ...props, children: [loading && (jsxRuntime.jsx("span", { className: "btn__spinner", "aria-hidden": "true", children: jsxRuntime.jsxs("svg", { className: "btn__spinner-icon", viewBox: "0 0 24 24", fill: "none", children: [jsxRuntime.jsx("circle", { cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4", className: "opacity-25" }), jsxRuntime.jsx("path", { fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", className: "opacity-75" })] }) })), !loading && leftIcon && (jsxRuntime.jsx("span", { className: "btn__icon btn__icon--left", children: leftIcon })), children && jsxRuntime.jsx("span", { className: "btn__text", children: children }), !loading && rightIcon && (jsxRuntime.jsx("span", { className: "btn__icon btn__icon--right", children: rightIcon }))] }));
});
...
const Input = react.forwardRef(({ size = 'md', variant = 'default', error = false, label, helperText, errorMessage, startIcon, endIcon, className = '', id, ...props }, ref) => {
    ...
    const inputClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: "input-wrapper", children: [jsxRuntime.jsxs("div", { className: "input-container", children: [startIcon && (jsxRuntime.jsx("div", { className: "input-icon input-icon--start", children: startIcon })), jsxRuntime.jsx("input", { ref: ref, id: inputId, className: inputClasses, placeholder: label ? " " : props.placeholder, ...(label ? { ...props, placeholder: " " } : props) }), endIcon && (jsxRuntime.jsx("div", { className: "input-icon input-icon--end", children: endIcon })), label && (jsxRuntime.jsx("label", { htmlFor: inputId, className: "input-label", children: label }))] }), (helperText || errorMessage) && (jsxRuntime.jsx("div", { className: `input-help ${error ? 'input-help--error' : ''}`, children: error && errorMessage ? errorMessage : helperText }))] }));
});
...
const Dropdown = ({ options, value, placeholder = 'Select an option', size = 'md', error = false, disabled = false, multiselect = false, onChange, label, helperText, errorMessage, className = '', id, ...props }) => {
    ...
    const triggerClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: "dropdown-wrapper", children: [label && (jsxRuntime.jsx("label", { htmlFor: dropdownId, className: "dropdown-label", children: label })), jsxRuntime.jsxs("div", { ref: dropdownRef, className: [baseClasses, sizeClasses, errorClasses, disabledClasses, openClasses]
                    .filter(Boolean)
                    .join(' '), children: [jsxRuntime.jsxs("button", { ref: buttonRef, id: dropdownId, type: "button", className: triggerClasses, onClick: handleToggle, disabled: disabled, "aria-haspopup": "listbox", "aria-expanded": isOpen, ...props, children: [jsxRuntime.jsxs("span", { className: "dropdown__trigger-content", children: [!multiselect && selectedOptions[0]?.icon && (jsxRuntime.jsx("span", { className: "dropdown__trigger-icon", children: selectedOptions[0].icon })), jsxRuntime.jsx("span", { className: "dropdown__trigger-text", children: getDisplayText() })] }), jsxRuntime.jsx("span", { className: "dropdown__trigger-arrow", children: jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6-1.41-1.41z" }) }) })] }), isOpen && (jsxRuntime.jsx("div", { className: "dropdown__menu", role: "listbox", children: jsxRuntime.jsx("div", { className: "dropdown__options", children: options.length === 0 ? (jsxRuntime.jsx("div", { className: "dropdown__no-options", children: "No options available" })) : (options.map((option, index) => {
                                const isSelected = selectedValues.includes(option.value);
                                return (jsxRuntime.jsxs("button", { type: "button", className: [
                                        'dropdown__option',
                                        ...
                                        .filter(Boolean)
                                        .join(' '), onClick: () => handleOptionSelect(option), disabled: option.disabled, role: "option", "aria-selected": isSelected, children: [option.icon && (jsxRuntime.jsx("span", { className: "dropdown__option-icon", children: option.icon })), jsxRuntime.jsx("span", { className: "dropdown__option-text", children: option.label }), isSelected && (jsxRuntime.jsx("span", { className: "dropdown__option-check", children: jsxRuntime.jsx("svg", { viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z" }) }) }))] }, option.value));
                            })) }) }))] }), (helperText || errorMessage) && (jsxRuntime.jsx("div", { className: `dropdown-help ${error ? 'dropdown-help--error' : ''}`, children: error && errorMessage ? errorMessage : helperText }))] }));
};
...
const Tabs = ({ items, activeTab, size = 'md', variant = 'underline', fullWidth = false, onChange, className = '', showContent = true, }) => {
    ...
    const tabsClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: tabsClasses, children: [jsxRuntime.jsxs("div", { className: "tabs__header", ref: tabsRef, children: [jsxRuntime.jsx("div", { className: "tabs__list", role: "tablist", children: items.map((tab) => {
                            const isActive = tab.id === activeTabId;
                            return (jsxRuntime.jsxs("button", { ref: isActive ? activeTabRef : null, type: "button", role: "tab", "aria-selected": isActive, "aria-controls": `tabpanel-${tab.id}`, className: [
                                    'tabs__tab',
                                    `tabs__tab--${size}`,
                                    `tabs__tab--${variant}`,
                                    ...
                                    .filter(Boolean)
                                    .join(' '), onClick: () => handleTabClick(tab), disabled: tab.disabled, children: [tab.icon && (jsxRuntime.jsx("span", { className: "tabs__tab-icon", children: tab.icon })), jsxRuntime.jsx("span", { className: "tabs__tab-text", children: tab.label }), tab.badge && (jsxRuntime.jsxs("span", { className: "tabs__tab-badge", children: ["(", tab.badge, ")"] }))] }, tab.id));
                        }) }), variant === 'underline' && (jsxRuntime.jsx("div", { className: "tabs__indicator", style: indicatorStyle }))] }), showContent && activeTabItem?.content && (jsxRuntime.jsx("div", { className: "tabs__content", role: "tabpanel", id: `tabpanel-${activeTabId}`, "aria-labelledby": `tab-${activeTabId}`, children: activeTabItem.content }))] }));
};
const TabPanel = ({ children, active = false, className = '', }) => {
    if (!active)
        return null;
    return (jsxRuntime.jsx("div", { className: `tab-panel ${className}`, children: children }));
};
...
const Tooltip = ({ content, children, placement = 'top', disabled = false, delay = 200, className = '', }) => {
    ...
    const tooltipClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: "tooltip-wrapper", children: [jsxRuntime.jsx("div", { ref: triggerRef, className: "tooltip-trigger", onMouseEnter: showTooltip, onMouseLeave: hideTooltip, onFocus: showTooltip, onBlur: hideTooltip, children: children }), isVisible && !disabled && (jsxRuntime.jsxs("div", { className: tooltipClasses, role: "tooltip", children: [jsxRuntime.jsx("div", { className: "tooltip-content", children: content }), jsxRuntime.jsx("div", { className: "tooltip-arrow" })] }))] }));
};
...
const RadioButton = react.forwardRef(({ label, error = false, size = 'md', className = '', disabled = false, id, ...props }, ref) => {
    ...
    const radioClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: wrapperClasses, children: [jsxRuntime.jsxs("div", { className: "radio-container", children: [jsxRuntime.jsx("input", { ref: ref, type: "radio", id: radioId, className: radioClasses, disabled: disabled, ...props }), jsxRuntime.jsx("div", { className: "radio-indicator", children: jsxRuntime.jsx("div", { className: "radio-dot" }) })] }), label && (jsxRuntime.jsx("label", { htmlFor: radioId, className: "radio-label", children: label }))] }));
});
...
const Checkbox = react.forwardRef(({ label, error = false, size = 'md', className = '', disabled = false, id, ...props }, ref) => {
    ...
    const checkboxClasses = [
        ...
        .filter(Boolean)
        .join(' ');
    return (jsxRuntime.jsxs("div", { className: wrapperClasses, children: [jsxRuntime.jsxs("div", { className: "checkbox-container", children: [jsxRuntime.jsx("input", { ref: ref, type: "checkbox", id: checkboxId, className: checkboxClasses, disabled: disabled, ...props }), jsxRuntime.jsx("div", { className: "checkbox-indicator", children: jsxRuntime.jsx("svg", { className: "checkbox-checkmark", viewBox: "0 0 16 16", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: jsxRuntime.jsx("path", { d: "M13.485 4.515a1 1 0 0 1 0 1.414l-6.5 6.5a1 1 0 0 1-1.414 0l-3-3a1 1 0 1 1 1.414-1.414L6.5 10.429l5.571-5.914a1 1 0 0 1 1.414 0z", fill: "currentColor", strokeWidth: "0" }) }) })] }), label && (jsxRuntime.jsx("label", { htmlFor: checkboxId, className: "checkbox-label", children: label }))] }));
});
...
const MaterialSymbols = {
    ...
    Search: ({ className, size = 24, style }) => (jsxRuntime.jsx("svg", { className: className, style: { width: size, height: size, ...style }, viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z" }) })),
    // Communication
    Email: ({ className, size = 24, style }) => (jsxRuntime.jsx("svg", { className: className, style: { width: size, height: size, ...style }, viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z" }) })),
    // Security & Privacy
    Visibility: ({ className, size = 24, style }) => (jsxRuntime.jsx("svg", { className: className, style: { width: size, height: size, ...style }, viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z" }) })),
    VisibilityOff: ({ className, size = 24, style }) => (jsxRuntime.jsx("svg", { className: className, style: { width: size, height: size, ...style }, viewBox: "0 0 24 24", fill: "currentColor", children: jsxRuntime.jsx("path", { d: "M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46C3.08 8.3 1.78 10.02 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z" }) })),
    // Actions & Controls
